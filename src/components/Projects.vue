...
const projectList = [
  { id: 1, title: "Project 1", description: "Description 1", src: "" },
  { id: 2, title: "Project 2", description: "Description 2", src: "" },
  { id: 3, title: "Project 3", description: "Description 3", src: "" },
];
</script>
<template>
